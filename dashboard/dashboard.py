...
fig, ax = plt.subplots()
weather_counts.plot(kind="bar", color=["#2ECC71", "#F1C40F", "#E74C3C"], ax=ax)
...
sns.heatmap(df.corr()[["cnt"]].sort_values(by="cnt", ascending=False), annot=True, cmap="coolwarm", ax=ax)
